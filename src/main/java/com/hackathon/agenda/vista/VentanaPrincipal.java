...
public class VentanaPrincipal extends JFrame {
    ...
    private void organizarLayout() {
        ...
        // Contenedor superior: formulario + botones juntos en la parte NORTE
    ...
    /** Rellena el formulario con los datos de un contacto (usado al seleccionar fila de la tabla). */
